...
// font-embedding problems for non-Latin scripts such as Coptic and Greek —
// the browser renders with its native fonts, exactly as the on-screen view.
...
// options.dir: 'ltr' (default) or 'rtl' — for right-to-left scripts
...
<style>
  ...
  * { -webkit-print-color-adjust: exact; print-color-adjust: exact; }
  body {
    font-family: 'Crimson Pro', 'Noto Sans', 'Antinoou', 'Noto Sans Coptic', serif;
