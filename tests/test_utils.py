...
def test_normalize_ref_is_idempotent_on_repaired_tags():
    for ref in ('sal.  Cat..58.15', 'pl. poen.  1', 'hp. Epid..1.1.1', 'a..b..1.1'):
        once = utils.normalize_ref(ref)
        assert utils.normalize_ref(once) == once
