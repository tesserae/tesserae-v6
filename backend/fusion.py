...
CHANNEL_LANGUAGE_SUPPORT = {
    ...
    "sound":         {"la", "grc", "cop", "en", "ur", "he", "ar"},  # character trigram Jaccard similarity (language-agnostic)
    "edit_distance": {"la", "grc", "cop", "en", "ur", "he", "ar"},  # Levenshtein fuzzy matching (language-agnostic)
    ...
    "quotation":     {"la", "grc", "cop", "en", "ur", "he", "ar"},  # runs of identical tokens — language-agnostic
}
