...
from backend.utils import (
    ...
    apply_text_list_filters, exact_phrase_pattern, exact_search_text,
    format_short_locus
)
                    ...
                    with open(filepath, 'r', encoding='utf-8') as f:
                        for line in f:
                            ...
                            if search_type == 'exact':
                                ...
                                # NFC-normalize the line so a Greek query in precomposed
                                # form matches text stored decomposed (e.g. Homer Il. 1.1
                                # μῆνιν ἄειδε is NFD in the corpus).
